...
void main(void) {
    ...
    while (1) { 
        ...
        char ir_sensor = PORTAbits.RA4 == 0 ? '0' : '1'; // sensor on RA4 , if RA4=0 sensor well be 0 else sensor is 1
        ...
        if(temp > 40.0){
            ...
            if(prevState == 1 & ir_sensor == '1'){
                ...
                PORTDbits.RD0 = 1; // tern buzzer on
            }
            else {
